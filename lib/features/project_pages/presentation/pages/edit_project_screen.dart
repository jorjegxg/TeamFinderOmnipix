...
class _EditProjectScreenState extends State<EditProjectScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) =>
          getIt<DetailsProvider>()..canBeDeleted(widget.projectId),
      child: Builder(builder: (context) {
        return ValueListenableBuilder(
          valueListenable:
              Hive.box<ProjectEntity>(HiveConstants.projectEntityBox)
                  .listenable(keys: [widget.projectId]),
          builder: (context, Box<ProjectEntity> box, child) =>
              Consumer2<EditProjectProvider, DetailsProvider>(
                  builder: (context, provider, provider2, child) {
            nameColtroler.text = box.get(widget.projectId)!.name;
            descriptionColtroler.text = box.get(widget.projectId)!.description;

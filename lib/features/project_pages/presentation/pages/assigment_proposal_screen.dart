...
class AssignmentProposalScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (ctx, box, _) => ChangeNotifierProvider(
        create: (context) => getIt<SendProposalProvider>()
          ..project =
              box.values.firstWhere((element) => element.id == projectId),

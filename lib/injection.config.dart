...
import 'package:team_finder_app/core/routes/app_route_config.dart' as _i14;
import 'package:team_finder_app/features/auth/data/repositories/auth_repo_impl.dart'
    as _i4;
import 'package:team_finder_app/features/auth/domain/auth_usecase.dart' as _i28;
...
import 'package:team_finder_app/features/settings/presentation/providers/add_skill_provider.dart'
    as _i21;
import 'package:team_finder_app/features/settings/presentation/providers/change_password_provider.dart'
    as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i6.ChangePasswordProvider>(
        () => _i6.ChangePasswordProvider());
    gh.factory<_i7.DepartmentRepositoryImpl>(
        () => _i7.DepartmentRepositoryImpl());
    gh.factory<_i8.DepartmentUseCase>(
        () => _i8.DepartmentUseCase(gh<_i7.DepartmentRepositoryImpl>()));
    gh.lazySingleton<_i9.DepartmentsGetCubit>(
        () => _i9.DepartmentsGetCubit(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i10.DepartmentsManagersCubit>(
        () => _i10.DepartmentsManagersCubit(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i11.EmployeeRepoImpl>(() => _i11.EmployeeRepoImpl());
    gh.factory<_i12.EmployeeUsecase>(
        () => _i12.EmployeeUsecase(gh<_i11.EmployeeRepoImpl>()));
    gh.factory<_i13.EmployeesProvider>(
        () => _i13.EmployeesProvider(gh<_i12.EmployeeUsecase>()));
    gh.singleton<_i14.MyAppRouter>(() => _i14.MyAppRouter());
    gh.lazySingleton<_i15.ProjectRepo>(() => _i16.ProjectRepoImpl());
    gh.factory<_i17.ProjectsUsecase>(
        () => _i17.ProjectsUsecase(gh<_i15.ProjectRepo>()));
    gh.factory<_i18.SendProposalProvider>(
        () => _i18.SendProposalProvider(gh<_i17.ProjectsUsecase>()));
    gh.factory<_i19.SettingsRepoImpl>(() => _i19.SettingsRepoImpl());
    gh.factory<_i20.SettingsUseCase>(
        () => _i20.SettingsUseCase(gh<_i19.SettingsRepoImpl>()));
    gh.singleton<_i21.SkillAssignmentProvider>(
        () => _i21.SkillAssignmentProvider(gh<_i20.SettingsUseCase>()));
    gh.factory<_i22.SkillReqProvider>(
        () => _i22.SkillReqProvider(gh<_i17.ProjectsUsecase>()));
    gh.factory<_i23.SkillStatisticsProvider>(
        () => _i23.SkillStatisticsProvider(gh<_i8.DepartmentUseCase>()));
    gh.singleton<_i24.TeamRolesProvider>(
        () => _i24.TeamRolesProvider(gh<_i20.SettingsUseCase>()));
    gh.factory<_i25.ValidationProvider>(
        () => _i25.ValidationProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i26.AddEmployeeToDepartamentProvider>(() =>
        _i26.AddEmployeeToDepartamentProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i27.AddMembersProvider>(
        () => _i27.AddMembersProvider(gh<_i17.ProjectsUsecase>()));
    gh.singleton<_i28.AuthUsecase>(() => _i28.AuthUsecase(
          gh<_i5.AuthenticationValidator>(),
          gh<_i3.AuthRepo>(),
        ));
    gh.factory<_i29.CreateProjectProvider>(
        () => _i29.CreateProjectProvider(gh<_i17.ProjectsUsecase>()));
    gh.singleton<_i30.CreateSkillProvider>(
        () => _i30.CreateSkillProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i31.DepartamentConfirmationProvider>(() =>
        _i31.DepartamentConfirmationProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i32.DepartamentEmployeesProvider>(
        () => _i32.DepartamentEmployeesProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i33.DepartamentProjectsProvider>(
        () => _i33.DepartamentProjectsProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i34.DepartamentSkillsProvider>(
        () => _i34.DepartamentSkillsProvider(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i35.DepartmentCreateCubit>(
        () => _i35.DepartmentCreateCubit(gh<_i8.DepartmentUseCase>()));
    gh.factory<_i36.EditEmployeeProvider>(
        () => _i36.EditEmployeeProvider(gh<_i12.EmployeeUsecase>()));
    gh.factory<_i37.EditProjectProvider>(
        () => _i37.EditProjectProvider(gh<_i17.ProjectsUsecase>()));
    gh.singleton<_i38.EmployeeRolesProvider>(
        () => _i38.EmployeeRolesProvider(gh<_i12.EmployeeUsecase>()));
    gh.singleton<_i39.OwnedSkillsProvider>(
        () => _i39.OwnedSkillsProvider(gh<_i20.SettingsUseCase>()));
    gh.singleton<_i40.PersonalSkillsProvider>(
        () => _i40.PersonalSkillsProvider(gh<_i20.SettingsUseCase>()));
    gh.singleton<_i41.ProfileProvider>(
        () => _i41.ProfileProvider(gh<_i20.SettingsUseCase>()));
    gh.factory<_i42.ProjectMembersProvider>(
        () => _i42.ProjectMembersProvider(gh<_i17.ProjectsUsecase>()));
    gh.factory<_i43.ProjectsBloc>(
        () => _i43.ProjectsBloc(gh<_i17.ProjectsUsecase>()));
    gh.factory<_i44.AuthBloc>(() => _i44.AuthBloc(gh<_i28.AuthUsecase>()));
    return this;
  }
}
